...
for(var prop in snake) {
	prop.indexOf('s') === 0 ? snake[prop] = 's' : null;
...
var doubleTheFun = (param) => {
	return typeof param == 'number' || isNaN(param) === false ? param * 2 : isNaN(param) ? param + param : null;
}

// #12 Write function getValueOfProperty that takes in an object, and the name of a property on the object
// return the value from the object that corresponds to the property
var getValueOfProperty = (obj, propName) => {
	return obj[propName];
};
...
var coderTest = (obj) => {
	for( var prop in obj) {
		obj[prop] === 'Jeremy' ? obj.lovesCode = 10 : obj[prop] === 'Brack' ? obj.lovesCode = 0 : obj.lovesCode = 5;
	}
	return obj;
}
